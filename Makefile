...
#
# To remake all the plots just use `make analysis`.  Though if you 
# are playing with analysis it may be easier to open analysis/fig.Rmd 
# in Rstudio (https://www.rstudio.com) and go from there.
